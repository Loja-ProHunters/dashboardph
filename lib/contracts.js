...
async function buildHeaderAndParties(doc, empresa, cliente, tituloContrato) {
  ...
  doc.addParagraph([
    ...
    { text: `, brasileiro, inscrito no CPF nº ${companies.representante.cpf}, residente e domiciliado na Rua Antônio da Veiga, nº 69, Térreo, Bairro Victor Konder, CEP: 89012-500 em Blumenau – SC. Doravante denominada simplesmente `, bold: false },
    { text: 'CONTRATADA.', bold: true },
  ]);
