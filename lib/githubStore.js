...
// getFileBinary — mesma lógica do getFile mas retorna Buffer (pra arquivos
// binários como .docx, .pdf, imagens). Contents API < 1MB, Blobs API >= 1MB.
...
// saveFileBinary — salva um Buffer (arquivo binário) no repo
