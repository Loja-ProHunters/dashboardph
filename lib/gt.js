...
function drawMinuta(doc, data) {
  ...
  let sx = LX;
  [['Serviço GOLLOG', 'Urgente'], ['Forma de Pagamento', g.formaPagamento || 'CONTA CORRENTE'],
  ...
  doc.field(LX, doc.y, thW, rH, 'Produto Predominante', g.produtoPredominante || '');
  ...
  doc.field(LX + segLbl + 110, doc.y, FW - segLbl - 110, segRH, 'Valor da Mercadoria', g.valorMercadoria || '');
  doc.y -= segRH;
